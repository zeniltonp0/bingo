<div>
    <form wire:submit="gerarCartelasBingo" class="  space-y-6">
        <div class="class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <input type="text" id="nomeBingo" wire:model="nomeBingo" class="mt-1 block w-auto" required rounded-md novalidate>
            @error('nomeBingo')
        ...
        <div>
            ...
            <input type="number" id="quantidadeCartelas" wire:model.live="quantidadeCartelas" min="1" max="200" class="mt-1 block w-auto" required novalidate>
        ...
        <div>
            <div class="mb-4">
                ...
                <p class="text-xs text-gray-500 mt-1">Um número por linha. Mínimo de 25 números únicos.</p>
